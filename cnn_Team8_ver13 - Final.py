...
'''
def create_model():
    # to test at lr= 0.0015, 0.001, 0.0005 
    optimizer = tf.keras.optimizers.Adam(lr=0.0005)  

    # create an empty neural network  
    model = tf.keras.Sequential()  

    # to adjust input shape and filters  
    ...
    # compile - decide whether to use loss function (loss='mse')  
...
def train_model(model, x_train, y_train, x_val, y_val):
    ...
    # train the model using augmented data, run test 12 with epochs=30 and test 13 with epochs=50
